        ...
        <div class="container bg-white">
            ...
            <div class="row p-4">
                ...
                <div class="col-12">
                    ...
                    <div class="row">
                        <div class="col-6">
                            <h5 class="font-weight-bold">District: <span
                        ...
                        <div class="col-6">
                            <h5 class="font-weight-bold">Floor: <span
                                    class="text-secondary"><?php echo $rowInfo['floor']; ?></span></h5>
                        </div>
                        <div class="col-6">
                            <h5 class="font-weight-bold">Flat: <span
                                    class="text-secondary"><?php echo $rowInfo['flat']; ?></span></h5>
                        </div>
                        <div class="col-6">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <h5 class="font-weight-bold">Telephone 2: <span
                                    class="text-secondary"><?php echo $rowLandLord['tel2']; ?></span></h5>
                        </div>
                        <?php }
                        if ($rowLandLord['tel3'] !== '') { ?>
                        <div class="col-6">
                            <h5 class="font-weight-bold">Telephone 3: <span
                                    class="text-secondary"><?php echo $rowLandLord['tel3']; ?></span></h5>
                        </div>
                        <?php } ?>
                        <div class="col-6">
                            <h5 class="font-weight-bold">Bank: <span
                                    class="text-secondary"><?php echo $rowLandLord['bank']; ?></span></h5>
                        </div>
                        <div class="col-6">
                            <h5 class="font-weight-bold">Account: <span
                                    class="text-secondary"><?php echo $rowLandLord['bank_acc']; ?></span></h5>
                        </div>
                        <div class="col-6">
                            <h5 class="font-weight-bold">Remarks: <span
                                    class="text-secondary"><?php echo $rowLandLord['remarks']; ?></span></h5>
                        </div>
                    ...
                    <div class="tab-content mt-3" id="myTabContent">
                        ...
                        <?php while ($row = mysqli_fetch_assoc($objFacilties)) { ?>
                        <?php  ?>
                        <div class="tab-pane fade" id="home<?php echo $row['room_number']; ?>" role="tabpanel"
                            aria-labelledby="home-tab<?php echo $row['room_number']; ?>">
                            <div class="row">
                    ...
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        ...
                        <?php if ($objRoom) { ?>
                        <?php while ($row = mysqli_fetch_assoc($objRoom)) { ?>
                    ...
                    <div class="tab-content mt-3" id="myTabContent">
                        ...
                        <div class="tab-pane fade" id="photo<?php echo $row['room_number']; ?>" role="tabpanel"
                            ...
                            <div class="row">
                                <?php $photos = $obj->insertRoomImage($row['room_number']) ?>
                                <?php if ($photos) { ?>
