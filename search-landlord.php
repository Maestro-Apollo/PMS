...
<body class="bg-light">
    ...
    <section>
        <div class="container bg-white pr-4 pl-4  log_section pb-5 pt-lg-4">
            <h4 class="font-weight-bold ">Landlord Information <p class="text-muted">(<span id="view"
                        class="font-weight-bold"></span> views
                    left today)</p>
            </h4>
            <form class="form-inline" id="myForm">
                <input class="form-control mr-sm-2" name="info" type="text" placeholder="Enter Building Name or Keyword"
                    aria-label="Search">
